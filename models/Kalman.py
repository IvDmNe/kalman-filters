...
class ExtendedKalmanFilter:
    def __init__(self,
        ...
        self.calc_K = jit(lambda pred_cov, H, obs_noise_cov:
                          pred_cov @ H.T @ inv(H @ pred_cov @ H.T + obs_noise_cov))
        self.calc_obs_noise = jit(
            lambda A, pred_cov, model_noise_cov: A @ pred_cov @ A.T + model_noise_cov)
    ...
    def step(self,
        ...
        self.pred_cov = self.calc_obs_noise(
